...
TEST_P(OrderBookTimingCaseTwo1, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo2, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo3, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo4, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo5, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo6, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo7, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo8, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo9, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo10, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo11, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo12, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo13, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo14, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo15, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo16, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo17, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo18, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo19, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo20, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo21, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo22, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo23, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo24, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo25, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo26, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo27, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo28, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo29, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo30, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo31, Run) { runTest("../data/caseTwoLockless.csv"); }
TEST_P(OrderBookTimingCaseTwo32, Run) { runTest("../data/caseTwoLockless.csv"); }
