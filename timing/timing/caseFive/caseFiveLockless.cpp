...
TEST_P(OrderBookTimingCaseFive1, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive2, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive3, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive4, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive5, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive6, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive7, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive8, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive9, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive10, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive11, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive12, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive13, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive14, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive15, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive16, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive17, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive18, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive19, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive20, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive21, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive22, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive23, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive24, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive25, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive26, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive27, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive28, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive29, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive30, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive31, Run) { runTest("../data/caseFiveLockless.csv"); }
TEST_P(OrderBookTimingCaseFive32, Run) { runTest("../data/caseFiveLockless.csv"); }
...
int main(int argc, char **argv) {
    ...
    ofstream file("../data/caseFiveLockless.csv");
