...
TEST_P(OrderBookTimingCaseSix1, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix2, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix3, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix4, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix5, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix6, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix7, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix8, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix9, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix10, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix11, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix12, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix13, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix14, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix15, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix16, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix17, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix18, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix19, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix20, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix21, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix22, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix23, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix24, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix25, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix26, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix27, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix28, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix29, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix30, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix31, Run) { runTest("../data/caseSixLocking.csv"); }
TEST_P(OrderBookTimingCaseSix32, Run) { runTest("../data/caseSixLocking.csv"); }
...
int main(int argc, char **argv) {
    ...
    ofstream file("../data/caseSixLocking.csv");
